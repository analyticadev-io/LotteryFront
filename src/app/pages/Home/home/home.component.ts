...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [NzLayoutModule, DrawerComponent, RolesComponent,CommonModule,NzGridModule],
...
export class HomeComponent {
  ...
  decryptUserInfo(userCookie:string){
    try{
      ...
      const bytes = CryptoJS.AES.decrypt(this.encryptedToken, this.encryptionKey);
